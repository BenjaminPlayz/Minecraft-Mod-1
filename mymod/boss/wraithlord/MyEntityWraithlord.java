...
public class MyEntityWraithlord extends EntityMob implements IBossDisplayData, IRangedAttackMob
{
   ...
   // private static final IEntitySelector attackEntitySelector = new EntityWitherAttackFilter();
    ...
    public MyEntityWraithlord(World par1World)
    {
        super(par1World);
    ...
    {
        this.dropItem(Main.MySword_4.itemID, 1);
    }
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(950.0D);
