...
public class MyEntityOgre extends EntityMob implements IRangedAttackMob
{
    private EntityAIArrowAttack aiArrowAttack = new EntityAIArrowAttack(this, 1.0D, 20, 60, 15.0F);
    private EntityAIAttackOnCollide aiAttackOnCollide = new EntityAIAttackOnCollide(this, EntityPlayer.class, 1.2D, false);

    public MyEntityOgre(World par1World)
    {
        super(par1World);
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setAttribute(0.5000000D);
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase par1EntityLivingBase, float par2)
    {
        ...
        if (i > 0)
        {
            entityarrow.setDamage(entityarrow.getDamage() + (double)i * 10.5D + 5.5D);
        }
