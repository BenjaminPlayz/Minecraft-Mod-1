...
public class MyEntityZombie extends EntityZombie
{
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setAttribute(5.5D);
        ...
        else
        {
            ...
            if (entity instanceof EntityPlayer)
            {
                ...
                for (int i = 0; i < list.size(); ++i)
                {
                    ...
                    if (entity1 instanceof MyEntityZombie)
                    {
                        MyEntityZombie entitypigzombie = (MyEntityZombie)entity1;
